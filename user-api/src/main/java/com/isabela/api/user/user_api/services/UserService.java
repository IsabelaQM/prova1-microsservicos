package com.isabela.api.user.user_api.services;
...
import com.isabela.api.user.user_api.models.User;
import com.isabela.api.user.user_api.models.dto.UserDTO;
import com.isabela.api.user.user_api.repositories.UserRepository;
...
public class UserService {
    ...
    public UserDTO editUser(String userId, UserDTO userDTO) {
        // Somente permiti editar o email, telefone e endereco
        User user = userRepository
                .findById(userId).orElseThrow(() -> new RuntimeException());
